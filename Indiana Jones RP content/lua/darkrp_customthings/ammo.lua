...
DarkRP.createAmmoType("ninemmgerman", {
    name = "9mm Perabellum",
    model = "models/Items/BoxSRounds.mdl",
    price = 30,
    amountGiven = 24
...
DarkRP.createAmmoType("sevensixtwopistol", {
    name = "7.62 Pistol Ammo",
    model = "models/Items/BoxSRounds.mdl",
    price = 30,
    amountGiven = 24
})

DarkRP.createAmmoType("fourtyfiveacp", {
    name = ".45 ACP",
    model = "models/Items/BoxSRounds.mdl",
    price = 30,
    amountGiven = 24
...
DarkRP.createAmmoType("panzerrocket", {
    name = "Panzer Rounds",
    model = "models/weapons/syndod/w_panzerfaust_rocket.mdl",
    price = 1000,
    amountGiven = 1
})

DarkRP.createAmmoType("bazookarocket", {
    name = "Bazooka Rounds",
    model = "models/weapons/syndod/w_panzerfaust_rocket.mdl",
    price = 1000,
    amountGiven = 1
...
DarkRP.createAmmoType("eightmmgerman", {
    name = "7.62 Mauser Ammo ",
    model = "models/Items/BoxSRounds.mdl",
    price = 30,
    amountGiven = 24
})

DarkRP.createAmmoType("shotgunshell", {
    name = "Shotgun ammo",
    model = "models/Items/BoxBuckshot.mdl",
    price = 50,
    amountGiven = 8
...
DarkRP.createAmmoType("thirtyoddsix", {
    name = "30.06 Ammo",
    model = "models/Items/BoxMRounds.mdl",
    price = 80,
    amountGiven = 30
...
DarkRP.createAmmoType("thirtycarbine", {
...
DarkRP.createAmmoType("sevensixtwobyfiftyfour", {
    name = "7.62 Ammo",
    model = "models/Items/BoxMRounds.mdl",
    price = 80,
    amountGiven = 30
